    ...
    <div className={css.container}>
      ...
      <div className={css.wrapper}>
        ...
        <DropDownSelector
          btnLabel={sensorNum}
          options={[
            10, 11, 12, 13, 14, 15, 16, 17, 20, 21, 22, 23, 24, 25, 26, 27, 30,
            31, 32, 33, 34, 35, 36, 37, 40, 41, 42, 43, 44, 45, 46, 47, 50, 51,
            52, 53, 54, 55, 56, 57, 60, 61, 62, 64, 65, 66, 67, 70, 71, 72, 73,
